  ...
  render() {
    return (
      ...
      <Table style={{width: '90%'}}>
        <TableHead>
          <TableRow>
            <TableCell>Detalles de notificaciones </TableCell>
            <TableCell align="right">Nuevo clientes </TableCell>
            <TableCell align="right">Enviar notificaciones a clientes </TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
          {not.map(row => (
